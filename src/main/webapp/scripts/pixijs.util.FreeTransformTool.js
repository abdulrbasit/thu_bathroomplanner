...
(function() {
    ...
    p.initialize = function(lineColor, dashed, handleColor, controlsSize, boundary) {
        ...
        // default values
        lineColor = 0x249cd3;//lineColor || 0x4285F4;
        handleColor = 0x249cd3;//handleColor || 0xffffff;
        //this.handleOpacity = 1;
        this.controlsSize = 15;//controlsSize || 10;
        ...
        function createHandle(name, cursor) {
            ...
            handle.alpha = 1;//this.handleOpacity;
        ...
        this.anchorMark.alpha = 1;//this.handleOpacity;
        ...
        function onRotateToolMove(moveEvent) {
            ...
            start_position = {x: relativeStartPoint['x'], y: relativeStartPoint['y']};
            end_position = {x: relativeEndPoint['x'], y: relativeEndPoint['y']};
